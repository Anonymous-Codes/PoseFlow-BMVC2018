...
if __name__ == '__main__':
    ...
    # notrack_json = "pose-results-{}.json".format(dataset) 
    notrack_json = "keypoint_result.json"
    ...
    with open(notrack_json,'r') as f:
        ...
        for imgpath in tqdm(sorted(notrack.keys())):
            ...
            for bid in range(len(notrack[imgpath])):
                ...
                track[vname][fname][bid+1]['box_pos'] = get_box(notrack[imgpath][bid]['keypoints'], os.path.join(image_dir,"images/"+imgpath[:-1]))
